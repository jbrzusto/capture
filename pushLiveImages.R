...
scpCommandTemplate = "ssh -p 30022 radar2@force2 mkdir /volume1/all/radar/fvc/jpg/%s;\
scp -P 30022 %s radar2@force2:/volume1/all/radar/fvc/jpg/%s &&\
scp -P 30022 %s/FORCERadarSweepMetadata.txt radar2@force2:/volume1/all/radar/fvc/latest_metadata.txt &&\
ssh -p 30022 radar2@force2 ln -s -f /volume1/all/radar/fvc/jpg/%s/%s /volume1/all/radar/fvc/latest_image.jpg"
