...
scpCommandTemplate = "ssh -p 30022 radar@force mkdir /volume1/all/radar/fvc/jpg/%s;\
scp -P 30022 %s radar@force:/volume1/all/radar/fvc/jpg/%s &&\
scp -P 30022 %s/FORCERadarSweepMetadata.txt radar@force:/volume1/all/radar/fvc/latest_metadata.txt &&\
ssh -p 30022 radar@force ln -s -f /volume1/all/radar/fvc/jpg/%s/%s /volume1/all/radar/fvc/latest_image.jpg"
